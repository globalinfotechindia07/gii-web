...
const Conditions = () => {
  return (
    <section className="bg-[#020617] text-gray-300 py-20 px-6 text-justify md:text-left">
      <div className="max-w-5xl mx-auto">
        ...
        {/* Intro */}
        <p className="mb-10 text-gray-400 leading-7">
          ...
          agree with any part of these terms, please discontinue use of our
          website immediately.
        </p>
        ...
        <div className="space-y-10">
          ...
          <div>
            ...
            <p className="text-gray-400 leading-7">
              ...
              not misuse, reverse-engineer, or attempt unauthorized access to
              any part of our platform or systems.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="text-gray-400 space-y-2 leading-7">
              ...
              <p>📧 info@globalinfotechindia.com</p>
