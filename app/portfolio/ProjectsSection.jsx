...
const projects = [
  ...
  ,{
    ...
    tag: "GOVTECH",
    title: "Replete",
    text: "A digital property tax application enabling citizens to view, calculate, and pay property taxes seamlessly, simplifying municipal revenue collection."
  }
];
