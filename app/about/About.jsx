  ...
  return (
    <>
      ...
      <Head>
        <meta
          name="keywords"
          content="global IT services company, AI software development, web development company, mobile app development, SaaS development services, custom software development, Next.js development company, hire remote developers, IT outsourcing company, digital transformation services"
        />
      </Head>

      <div className="bg-[#020617] text-gray-300 min-h-screen py-10">
        ...
        <section className="px-6 sm:px-10 lg:px-10 py-10 sm:py-24">
          ...
          >
            ...
            <p className="text-gray-400 leading-relaxed text-sm sm:text-base">
              ...
              simplifies operations and accelerates growth.
            </p>
