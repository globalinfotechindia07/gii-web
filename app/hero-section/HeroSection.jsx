...
const HeroSection = () => {
  ...
  return (
    <>
      {/* ✅ SEO META ONLY */}
      <Head>
        <title>Global Infotech India | Web Development, AI & Software Company</title>

        <meta
          name="description"
          content="Global Infotech India is a leading web development, AI, and software development company providing scalable digital solutions, SaaS platforms, and enterprise applications worldwide."
        />

        <meta
          name="keywords"
          content="web development company, AI software development, SaaS development, custom software development, IT company India, Next.js development, mobile app development, digital transformation company, global IT services"
        />
      </Head>
